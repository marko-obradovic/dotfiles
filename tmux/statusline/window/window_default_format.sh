show_window_default_format() {
  ...
  local text="$(get_tmux_option "@window_default_text" "#{b:pane_current_path}")" # use #W for application instead of directory
  local fill="$(get_tmux_option "@window_default_fill" "number")"                 # number, all, none
