show_window_current_format() {
  ...
  local text="$(get_tmux_option "@window_current_text" "#{b:pane_current_path}")" # use #W for application instead of directory
  local fill="$(get_tmux_option "@window_current_fill" "number")"                 # number, all, none
